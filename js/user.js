  ...
  const games = [
    {
      ...
      description: "Recluta a un equipo de inadaptados con habilidades únicas y personalidades inolvidables, y persigue a Banished Court hasta los confines de la Tierra en una combinación de infiltración, combate por turnos y una historia de aventuras e intrigas.",
      price: "28.24",
      stockQuantity: "20",
      category: ["aventura", "rol", "estrategia"],
      URLimage: "https://aor-images-prod.s3.amazonaws.com/ajwckdtg7v56yrz9tg4jn6eiw78q",
      requirements: {
        ...
        memory: "8 GB de RAM",
        grafic: "Gráficos: AMD® Radeon™ R9 380 (4GB) or Nvidia® GeForce™ GTX 950 (2GB)",
    ...
    },
    {
      code: 2,
      name: "Firewatch",
      description: "Firewatch es un juego de misterio en primera persona para un jugador que se desarrolla en la selva de Wyoming.",
      price: "1.16",
      stockQuantity: "30",
      category: ["aventura", "misterio", "casual"],
      URLimage: "https://cdn.akamai.steamstatic.com/steam/apps/383870/capsule_616x353.jpg?t=1688484486",
      requirements: {
        general: "Requiere un procesador y un sistema operativo de 64 bits",
    ...
    },
    {
      ...
      URLimage: "https://cdnb.artstation.com/p/assets/images/images/029/978/775/large/isa-osa-.jpg?1599216317",
      requirements: {
        general: "Requiere un procesador y un sistema operativo de 64 bits",
    ...
    },
    {
      ...
      description: "Confecciona un equipo de talla mundial que tumbe a los rivales en las competiciones de fútbol más prestigiosas. El progreso nunca se detiene cuando persigues la excelencia.",
      price: "43.00",
      stockQuantity: "50",
      ...
      requirements: {
        ...
        memory: "4 GB de RAM",
        grafic: "Intel GMA X4500, NVIDIA GeForce 9600M GT, AMD/ATI Mobility Radeon HD 3650 - requires 256MB VRAM and DirectX® 11",
    ...
    },
    {
      code: 5,
      name: "Backpack Hero",
      description: "¡El roguelike con manejo de inventario! Recoge objetos raros, organiza tu mochila y derrota a tus oponentes!",
      price: "9.30",
      stockQuantity: "14",
      category: ["estrategia", "fantasia", "construcción","aventura"],
      URLimage: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNAOsqRiH1mEs08EvxeOamvPxXJvrx6SHGJQ",
      requirements: {
        general: "Requiere un procesador y un sistema operativo de 64 bits",
